...
$sql="DELETE FROM cantprosdb.C_DIAG_BIOPSIA WHERE ID_REGISTRO=$IdRegistro;";
mysqli_query($conexion,$sql);

$sql="INSERT INTO cantprosdb.C_DIAG_BIOPSIA (ID_REGISTRO,CR_FECHA_BIOPSIA,CR_OTROCILINDRO,CR_OTRORHP,CR_GLEASON1,CR_GLEASON2
