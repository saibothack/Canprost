...
*/
//seccion datos
$dateRTUP=isset($_REQUEST["dateRTUP"])?$_REQUEST["dateRTUP"]:"";
$dRTUP=isset($_REQUEST["dRTUP"])?$_REQUEST["dRTUP"]:"";
...
$fechaRTUP=isset($_REQUEST["fechaRTUP"])?$_REQUEST["fechaRTUP"]:"";
...
$sql="DELETE FROM cantprosdb.C_DIAG_RTUP WHERE ID_REGISTRO=$IdRegistro;";
mysqli_query($conexion,$sql);

$sql="INSERT INTO cantprosdb.C_DIAG_RTUP (ID_REGISTRO,CR_OTRORHP,CR_GLEASON1,CR_GLEASON2
,CR_APE_TOTAL,CR_APE_LIBRE,CR_DESCONOCIDO,CR_OTROSMARCADORES,CR_ESTUDIOIMAGEN,CR_OTRO_MARCADOR,CR_OTRO_TAC,CR_OTRO_RMI
,CR_OTRO_PET,CR_OTRO_GGO,CR_VIGILANCIA_ACTIVA,CR_PROGRESION_VIGILANCIA,CR_DIFERIDO,CR_NUMERO_LESIONES,C_RTUP,CDR_date_RTUP,CR_GLEASONSUMA,CR_GLEASON_DESCONOCIDO
)
 ...
 ,'$sVigilanciaActiva','$sProgresionVigilancia','$sDiferido','$sNumeroLesiones','$dRTUP','$fechaRTUP','$iGleasonsuma','$iGleasondesconocido');";
mysqli_query($conexion,$sql);
