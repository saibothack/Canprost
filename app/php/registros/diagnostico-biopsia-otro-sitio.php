...
*/
//seccion datos
$dBiopsia=isset($_REQUEST["dBiopsia"])?$_REQUEST["dBiopsia"]:"";
...
if($_REQUEST["sEstudiosImagen"] == "on"){
	$sEstudiosImagen = "1";
}else{
	$sEstudiosImagen = "0";
}
...
$sProgresionVigilancia=isset($_REQUEST["sProgresion"])?$_REQUEST["sProgresion"]:"";
...
$iGleasonsuma=isset($_REQUEST["iGleasonsuma"])?$_REQUEST["iGleasonsuma"]:"";
$iGleasondesconocido=isset($_REQUEST["iGleasondesconocido"])?$_REQUEST["iGleasondesconocido"]:"";

$sql="DELETE FROM cantprosdb.C_DIAG_BIOPSIA_OTRO_SITIO WHERE ID_REGISTRO=$IdRegistro;";
mysqli_query($conexion,$sql);

$sql="INSERT INTO cantprosdb.C_DIAG_BIOPSIA_OTRO_SITIO (ID_REGISTRO,CR_FECHA_BIOPSIA,CR_OTRORHP,CR_GLEASON1,CR_GLEASON2
,CR_APE_TOTAL,CR_APE_LIBRE,CR_DESCONOCIDO,CR_ESTUDIOIMAGEN,CR_OTRO_TAC,CR_OTRO_RMI
,CR_OTRO_PET,CR_OTRO_GGO,CR_VIGILANCIA_ACTIVA,CR_PROGRESION_VIGILANCIA,CR_DIFERIDO,CR_NUMERO_LESIONES,CR_GLEASONSUMA,CR_GLEASON_DESCONOCIDO
)
 VALUES('$IdRegistro','$dBiopsia','$sOtroRHP','$iGleason1','$iGleason2','$iAPETotal','$iAPELibre',
 '$sDesconocido','$sEstudiosImagen','$sOtroTac','$sOtroRMI','$sOtroPET','$sOtroGGO'
 ,'$sVigilanciaActiva','$sProgresionVigilancia','$sDiferido','$sNumeroLesiones','$iGleasonsuma','$iGleasondesconocido');";
mysqli_query($conexion,$sql);
