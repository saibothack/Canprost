...
$sql = "DELETE FROM `cantprosdb`.`C_RELACION_REGISTROS` where `ID_REGISTRO` = '$IdRegistro' and `ID_TIPO_CAMPO` BETWEEN 67 AND 69;";
...
$dultimaconsulta=isset($_REQUEST["dultimaconsulta"])?$_REQUEST["dultimaconsulta"]:"";
$cualmuerte=isset($_REQUEST["cualmuerte"])?$_REQUEST["cualmuerte"]:"";
$dMuerte=isset($_REQUEST["dMuerte"])?$_REQUEST["dMuerte"]:"";
$observaciones=isset($_REQUEST["observaciones"])?$_REQUEST["cualmuerte"]:"";
$dProximaVisita=isset($_REQUEST["dProximaVisita"])?$_REQUEST["dProximaVisita"]:"";
$cerradopor=isset($_REQUEST["cerradopor"])?$_REQUEST["cerradopor"]:"";
...
$sql="DELETE FROM cantprosdb.C_ESTATUS WHERE ID_REGISTRO=$IdRegistro;";
mysqli_query($conexion,$sql);

$sql="INSERT INTO cantprosdb.C_ESTATUS (ID_REGISTRO,CRFECHA_ULTIMA_CONSULTA,CR_CUALMUERTE,CR_FECHAMUERTE,CR_OBSERVACIONES,CR_CERRADO,CR_FECHA_PROXIMA)
 VALUES($IdRegistro,'$dultimaconsulta','$cualmuerte','$dMuerte','$observaciones','$cerradopor','$dProximaVisita');";
mysqli_query($conexion,$sql);
