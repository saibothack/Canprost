...
$sOtroCilindro=isset($_REQUEST["sOtroCilindro"])?$_REQUEST["sOtroCilindro"]:"";
...
$sql="DELETE FROM cantprosdb.C_DIAG_BIOPSIA_SATURACION WHERE ID_REGISTRO=$IdRegistro;";
mysqli_query($conexion,$sql);

$sql="INSERT INTO cantprosdb.C_DIAG_BIOPSIA_SATURACION (ID_REGISTRO,CR_FECHA_BIOPSIA,CR_OTROCILINDRO,CR_OTRORHP,CR_GLEASON1,CR_GLEASON2
...
,CR_OTRO_PET,CR_OTRO_GGO,CR_VIGILANCIA_ACTIVA,CR_PROGRESION_VIGILANCIA,CR_DIFERIDO,CR_NUMERO_LESIONES,CR_GLEASONSUMA,CR_GLEASON_DESCONOCIDO
 ...
 VALUES('$IdRegistro','$dBiopsia','$sOtroCilindro','$sOtroRHP','$iGleason1','$iGleason2','$iAPETotal','$iAPELibre',
