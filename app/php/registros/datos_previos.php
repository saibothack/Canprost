...
$sql = "DELETE FROM `cantprosdb`.`C_RELACION_REGISTROS` where `ID_REGISTRO` = '$IdRegistro' and `ID_TIPO_CAMPO` = 77;";
...
$sOtroTratamientoPreventivo=$_REQUEST["sOtroTratamientoPreventivo"];
...
$sql = "UPDATE cantprosdb.C_REGISTROS SET OTRO_PREVIO = '$sOtroTratamientoPreventivo' WHERE ID_REGISTRO = $IdRegistro";
