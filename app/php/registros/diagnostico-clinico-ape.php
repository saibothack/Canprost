...
*/
//seccion datos
$dNivelApe=isset($_REQUEST["nivel_ape"])?$_REQUEST["nivel_ape"]:"";
...
$sql="DELETE FROM cantprosdb.C_DIAG_CLINICO_APE WHERE ID_REGISTRO=$IdRegistro;";
mysqli_query($conexion,$sql);

$sql="INSERT INTO cantprosdb.C_DIAG_CLINICO_APE (ID_REGISTRO,CR_FECHA_BIOPSIA,CR_OTROCILINDRO,CR_OTRORHP,CR_GLEASON1,CR_GLEASON2
,CR_APE_TOTAL,CR_APE_LIBRE,CR_DESCONOCIDO,CR_OTROSMARCADORES,CR_ESTUDIOIMAGEN,CR_OTRO_MARCADOR,CR_OTRO_TAC,CR_OTRO_RMI
,CR_OTRO_PET,CR_OTRO_GGO,CR_VIGILANCIA_ACTIVA,CR_PROGRESION_VIGILANCIA,CR_DIFERIDO,CR_NUMERO_LESIONES,CR_NIVEL_APE
)
 ...
 ,'$sVigilanciaActiva','$sProgresionVigilancia','$sDiferido','$sNumeroLesiones','$dNivelApe');";
mysqli_query($conexion,$sql);
