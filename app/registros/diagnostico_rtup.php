...
<head>
    <meta charset="utf-8">
    <title>RTUP / Adenomectomía</title>
...
<body>
<h1>Diagnóstico por RTUP / Adenomectomía</h1>

    <!--Empieza formulario RTUP-->
    <div id="tabs-4">
        <form class="form-horizontal" id="form_diagnostico6">
            <div class="form-group">
                <label for="dCirugia" class="col-sm-2 control-label">Fecha de RTUP</label>
                <div class="col-sm-3">
                    <input type="date"  class="form-control"
                           name="fechaRTUP" id="fechaRTUP" placeholder="Fecha de RTUP" >
                </div>
            </div>
            <div class="form-group">
				<label for="dCirugia" class="col-sm-2 control-label">RTUP / Adenomectomía</label>
				<div class="col-sm-1">
					<input type="checkbox"  name="dRTUP" id="dRTUP">
				</div>
            ...
            <div class="form-group" >
                ...
                <div id="campoGleason">
                    ...
                    <div class="col-sm-2">
                        <input type="number" name="iGleason1" id="iGleason1" min="1" max="10" maxlength="2" onchange="iGleason1V()" onblur="iGleason1V()" class="form-control">
                        </div>
                    <div class="col-sm-2">
                        <input type="number" name="iGleason2" id="iGleason2" min="1" max="10" maxlength="2" onchange="iGleason2V()" onblur="iGleason2V()" class="form-control">
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="form-group" id="GGO" >
                    ...
                    <div id="OtroGGO"  hidden>
                        ...
                        <div class="col-sm-4">
                            ...
                            <label for="sOtroGGO" class="col-sm-1 control-label">Número de lesiones</label>
                            <div class="col-sm-2">
    ...
    function asignarValoresRegistros(){
        <?php
           if (  $_SESSION["idRegistro"]<>""){
            ?>
        cargaRegistroSeleccionado(<?php echo($_SESSION["idRegistro"]); ?>,"3");
        <?php
            }
        ?>
    }
