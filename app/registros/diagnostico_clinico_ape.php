...
<body>
<h1>Diagnóstico por  APE y/o TR</h1>


<!--Empieza formulario-->
<div id="tabs-4">
    <form class="form-horizontal" id="form_diagnostico4">
        <div class="form-group">
            <label for="dCirugia" class="col-sm-2 control-label">Nivel actual de APE</label>
            <div class="col-sm-4">
                <input type="text" class="form-control" name="nivel_ape" id="nivel_ape" placeholder="Nivel APE">
            </div>
            <label for="rg_campo_76" class="col-sm-2 control-label">Tacto Rectal</label>
            <div class="col-sm-4" id="rg_campo_76">
            </div>
        </div>
       <!-- <div class="form-group" hidden>
            <label for="dCirugia" class="col-sm-2 control-label">Fecha de Biopsia</label>
            <div class="col-sm-3">
                <input type="date"  class="form-control" name="dBiopsia" id="dBiopsia" placeholder="Fecha de Biopsia" required>
            </div>
        </div>
        <div class="form-group" hidden>
            <div id="rg_campo_13" class="col-sm-6">
                <label for="rg_campo_13" class="col-sm-4 control-label">Numero de Cilindros por Biopsia</label>
            </div>
            <div id="OtroCilindro" hidden class="col-sm-6">
        ...
        <div class="form-group" hidden>
            ...
            <div id="OtroRHP"  hidden class="col-sm-6">
        ...
        <div class="form-group" hidden>
            <div class="col-sm-3">
                <label for="iAPELibre" class="col-sm-8 control-label">Otros Marcadores</label>
                <div class="col-sm-4">
            ...
            <div class="col-sm-9" id="OtrosMarcadores" hidden>
                ...
                <div class="col-sm-6" id="OtroMarcador"  hidden>
        ...
        <div class="form-group" id="EstudiosImagen" hidden>
            <div class="form-group" id="TAC" >
                ...
                <div id="rg_campo_71" style="width: 80%;display: inline-block;">
                   <!--<div class="col-sm-3">
						<input type="radio" name="sNombres" id="sNombres">No Realizado
					</div>
                   <div class="col-sm-2">
						<input type="radio" name="sNombres" id="sNombres">Negativo
					</div>
                   <div class="col-sm-2">
						<input type="radio" name="sNombres" id="sNombres">Positivo
					</div>-->
                </div>
                ...
                <div id="OtroTac"  hidden>
                    ...
                    <div class="col-sm-4">
                        <select class="form-control" id="campo_19" name="campo_19" onChange="validaSeleccion(this)">
                    ...
                    <div id="EspecificaTAC" hidden>
                        <label for="sOtroTac" class="col-sm-2 control-label">Especificar otro</label>
                        <div class="col-sm-4">
        ...
        <div class="form-group" >
			...
			<div class="col-sm-4">
				<div class="col-sm-3">
					<label><input type="radio" name="sVigilanciaActiva" value="1">Si</label>
				</div>
				<div class="col-sm-3">
					<label><input type="radio" name="sVigilanciaActiva" value="2">No</label>
				</div>
				<div class="col-sm-6">
					<label><input type="radio" name="sVigilanciaActiva" value="3">Desconocido</label>
				</div>
   			</div>
            <label for="iAPELibre" class="col-sm-2 control-label">Progresión post-vigilancia activa</label>
            <div class="col-sm-4">
				<div class="col-sm-3">
					<label><input type="radio" name="sProgresion" value="1">Si</label>
				</div>
				<div class="col-sm-3">
					<label><input type="radio" name="sProgresion" value="2">No</label>
				</div>
				<div class="col-sm-6">
					<label><input type="radio" name="sProgresion" value="3">Desconocido</label>
				</div>
			</div>
	   	</div>
        <div class="form-group">	
            ...
            <div class="col-sm-4">
				<div class="col-sm-3">
					<label><input type="radio" name="sDiferido" value="1">Si</label>
				</div>
				<div class="col-sm-3">
					<label><input type="radio" name="sDiferido" value="2">No</label>
				</div>
				<div class="col-sm-6">
					<label><input type="radio" name="sDiferido" value="3">Desconocido</label>
				</div>
			</div>
        </div>
        <div class="form-group">
            <div class="col-sm-offset-9 col-sm-3">
                <button type="button" class="btn btn-primary" id="continuarGeneral" onclick="guardarDiagnostico4()">Guardar</button>
            </div>
        </div>
    </form>
</div>
    ...
    function asignarValoresRegistros(){
        <?php
           if (  $_SESSION["idRegistro"]<>""){
            ?>
        cargaRegistroSeleccionado(<?php echo($_SESSION["idRegistro"]); ?>,"2");
        <?php
            }
        ?>
    }
